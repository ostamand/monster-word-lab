...
export default function Home() {
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-black font-sans selection:bg-violet-500/30">
      {/* Background Layer - The "Frame" Texture */}
      ...
      {/* Foreground Layer - The "Main Scene" inset with border radius */}
      ...
      <main className="relative z-30 flex min-h-screen flex-col items-center justify-between pb-8 pt-12 sm:pb-12 sm:pt-20 md:pb-16 md:pt-32 pointer-events-none">
        {/* Pointer events allow clicking buttons but passing through clicks to potentially interactive background elements if any */}
        <div className="pointer-events-auto contents">
          {/* Title */}
          <div className="animate-fade-in-down opacity-0" style={{ animationDelay: "0ms" }}>
            <Image
              src="/landing/title.png"
              alt="Monster Word Lab"
              width={800}
              height={400}
              className="w-[350px] md:w-[600px] lg:w-[800px] h-auto drop-shadow-2xl"
              priority
            />
          </div>

          {/* Action Buttons */}
          <div className="flex flex-col gap-6 sm:flex-row sm:gap-16 animate-fade-in-up opacity-0" style={{ animationDelay: "300ms" }}>
